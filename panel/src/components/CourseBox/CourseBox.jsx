...
const dispatch = useDispatch()
  ...
  const removeHandler=()=>{
    swal({
      ...
      if (res){
        dispatch(removeCourseFromServer(props._id))
        swal({
                ...
                <div className="coursebox-left">
                    ...
                    <div className="coursebox-left-bottom">
                        <div className="coursebox-info">
                           ...
                           <ul>
                                <li><a href=""><MdPriceChange/> قیمت:{props.price ===0 ? "رایگان":props.price.toLocaleString()}</a></li>
                                <li><a href=""><AiFillFolder></AiFillFolder> دسته بندی : {props.category}</a></li>
                                <li><a href=""><MdFamilyRestroom/>تعداد  ثبت نامی :{props.registersCount}</a></li>
                            </ul>
                           </div>
