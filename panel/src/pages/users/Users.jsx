      ...
      <div className="add-remove-user">
        <div className="row">
          <div className="col-md-9 ">
            <div className=' add-user-input'><span><input type="text" placeholder='نام و یا ایمیل کاربر را وارد نمایید...' /></span></div>

           
          </div>
          <div className="col-md-3">
          <div className=' remove-user-input'> <button  >حذف</button></div>
          </div>
        </div>
      </div>
